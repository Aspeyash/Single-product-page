...
$classes = array( 'zymarg-sp-swatch', 'zymarg-sp-swatch--color' );
if ( $is_selected ) {
	$classes[] = 'selected';
}
if ( ! $is_available ) {
...
<li class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"
	...
	style="--zsp-swatch-color:<?php echo esc_attr( $color ); ?>;">
	<span class="zymarg-sp-swatch-color-inner" style="background-color:<?php echo esc_attr( $color ); ?>;"></span>
